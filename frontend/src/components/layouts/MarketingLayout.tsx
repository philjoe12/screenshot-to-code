        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <div>
              ...
              <ul className="mt-4 space-y-4">
                ...
                <li><Link to="/gallery" className="text-base text-gray-300 hover:text-white">Gallery</Link></li>
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li><Link to="/privacy-policy" className="text-base text-gray-300 hover:text-white">Privacy</Link></li>
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
            ...
            <p className="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
              &copy; {new Date().getFullYear()} Pix2Code. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
